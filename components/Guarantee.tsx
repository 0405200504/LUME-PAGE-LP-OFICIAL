...
export default function Guarantee() {
  return (
    <section id="garantia" className="bg-cream py-20 sm:py-28">
        ...
        <div className="mt-12 grid gap-5 sm:grid-cols-3">
          {selos.map((s, i) => (
            <Reveal key={s.titulo} delay={i * 0.1}>
              <div className="flex h-full flex-col items-center rounded-3xl border border-rose/50 bg-offwhite p-7 text-center sm:p-8">
