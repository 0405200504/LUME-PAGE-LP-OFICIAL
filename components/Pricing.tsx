  ...
  return (
    <section id="planos" className="bg-offwhite py-20 sm:py-28">
      <div className="container-lume">
        ...
        <Reveal delay={0.05}>
          <div className="mt-10 flex justify-center">
            <div
              ...
              className="inline-flex items-center gap-1 rounded-full border border-rose/60 bg-cream p-1"
            >
              <button
                type="button"
                ...
                className={`rounded-full px-5 py-2.5 text-sm font-semibold transition-all duration-300 ${
                  !anual
                    ? "bg-bordo text-offwhite shadow-soft"
              ...
              <Reveal key={p.nome} delay={i * 0.1}>
                <div
                  className={`grain relative flex h-full flex-col overflow-hidden rounded-[2rem] p-7 sm:p-8 ${
                    dark
                      ? "bg-gradient-to-br from-bordo to-bordo-deep text-offwhite shadow-glow lg:-mt-4 lg:pb-12"
                      : "border border-rose/50 bg-cream"
                  }`}
                >
                  {dark && (
                  ...
                  <div className="mt-8">
                    <Button
                      className={`w-full ${
                        dark ? "bg-offwhite !text-bordo hover:bg-cream" : ""
                      }`}
                    >
                      Começar grátis
                    </Button>
        ...
        {/* reforço + ancoragem */}
        <Reveal delay={0.15}>
          <div className="mx-auto mt-10 max-w-3xl rounded-[2rem] border border-bordo/15 bg-cream px-7 py-9 text-center sm:px-12">
