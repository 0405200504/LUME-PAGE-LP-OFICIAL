...
export default function ClientJourney() {
  return (
    <section id="o-que-ela-ve" className="bg-cream py-20 sm:py-28">
      <div className="container-lume">
          ...
          <div className="space-y-4">
            {pontos.map((p, i) => (
              <Reveal key={p.ve} delay={i * 0.08}>
                <div className="rounded-3xl border border-rose/50 bg-offwhite p-6 sm:p-7">
        ...
        <Reveal delay={0.1}>
          <div className="mt-14 rounded-3xl border border-bordo/15 bg-offwhite px-7 py-8 text-center sm:px-12">
