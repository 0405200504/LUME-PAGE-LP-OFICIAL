...
/** CTA fixo no rodapé apenas no mobile — sempre aponta para o WhatsApp. */
  ...
  return (
    ...
    >
      <a
        ...
        className="flex w-full items-center justify-center gap-2 rounded-full bg-bordo py-3.5 text-sm font-semibold text-offwhite shadow-glow"
      >
