...
export default function Comparison() {
  return (
    <section id="antes-depois" className="bg-cream py-20 sm:py-28">
      <div className="container-lume">
        ...
        <Reveal delay={0.1}>
          <div className="mx-auto mt-12 max-w-4xl overflow-hidden rounded-[2rem] border border-rose/50 bg-offwhite shadow-soft">
