...
export default function MockupDashboard({
  ...
  return (
    <div
      className={`w-full max-w-md rounded-3xl border border-rose/60 bg-offwhite p-4 shadow-card ${className}`}
    >
      {/* header do painel */}
      ...
      <div className="mt-4 grid grid-cols-3 gap-2">
        {[
          ...
          <div
            key={c.label}
            className="rounded-2xl border border-rose/50 bg-cream px-2.5 py-2.5"
          >
      ...
      <div className="mt-3 grid grid-cols-5 gap-2">
        {/* gráfico */}
        <div className="col-span-3 rounded-2xl border border-rose/50 bg-cream p-3">
        ...
        {/* próximos */}
        <div className="col-span-2 rounded-2xl border border-rose/50 bg-cream p-3">
      ...
      <div className="mt-3 rounded-2xl border border-rose/50 bg-cream p-3">
        <div className="flex items-center justify-between">
          <p className="text-[10px] font-semibold text-grafite">
