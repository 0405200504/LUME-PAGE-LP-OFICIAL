...
export default function CostSection() {
  return (
    <section id="a-conta" className="bg-cream py-20 sm:py-28">
      <div className="container-lume">
        ...
        <div className="mx-auto mt-12 max-w-3xl space-y-4">
          {linhas.map((l, i) => (
            <Reveal key={l.label} delay={i * 0.08}>
              <div className="flex flex-col gap-4 rounded-3xl border border-rose/50 bg-offwhite p-6 sm:flex-row sm:items-center sm:justify-between sm:p-7">
        ...
        {/* total */}
        <Reveal delay={0.15}>
          <div className="grain relative mx-auto mt-6 max-w-3xl overflow-hidden rounded-[2rem] bg-gradient-to-br from-bordo to-bordo-deep px-7 py-10 text-center text-offwhite shadow-glow sm:px-12">
            <Sparkle
              size={20}
